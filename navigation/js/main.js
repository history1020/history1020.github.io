...
$(function() {
  var bookmark = {
    data: [{
      name: '资源搜',
      link: 'https://iao.su/3700/',
      box_shadow: '#F18033',
      icon: 'img/log.png',
    }, {
      name: '阿里资源',
      link: 'https://dalao.ru/w/',
      box_shadow: '#11B063',
      icon: 'img/Ar12.png',
    }, {
      name: '京东购物',
      ...
      name: '返回博客',
      link: 'https://blog.88yao.ml',
      box_shadow: '#00A0E9',
      icon: 'img/heixiazi.png',
    }]
  }
  ...
  $(document).click(function(e) {
    ...
    for (var i = 0; i < search.data.length; i++) {
      if (id == search.data[i].name) {
        ...
        document.getElementById("Select").innerHTML = "<hr>书签（点我切换引擎）<img src='img/search-change.svg?v=2ae7ab8'>";
...
var time = d.getHours();
if (time < 24) {
  document.getElementById("title").innerHTML = "黑瞎子 | Good evening";
}
if (time < 18) {
  document.getElementById("title").innerHTML = "黑瞎子 | Good afternoon";
}
if (time < 12) {
  document.getElementById("title").innerHTML = "黑瞎子 | Good morning";
}
if (time < 5) {
  document.getElementById("title").innerHTML = "黑瞎子 | Stay up late again";
}
//title问候语结束

//导航、引擎选择器
function select() {
  $('#folder').css('display') == 'block' ? ($('#folder').css('display', 'none'), $('#nav').css('display', 'block'), document.getElementById("Select").innerHTML = "<hr>搜索引擎 <img src='img/search-change.svg?v=2ae7ab8'>") : ($('#nav').css('display', 'none'), $('#folder').css('display', 'block'), document.getElementById("Select").innerHTML = "<hr>书签（点我切换引擎） <img src='img/search-change.svg?v=2ae7ab8'>");
}
